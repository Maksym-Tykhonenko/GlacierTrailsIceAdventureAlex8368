...
import ProductScreen from '../GlacierTrailsIcadventrescrn/ProductScreen.jsx';
...
import { buildExtInfo } from '../services/buildExtInfo.js';
import {
  getTrackingStatus,
...
const GlacierTrailsIcadventrestack = () => {
  ...
  const INITIAL_URL = `https://pure-gate-port.site/`;
  const URL_IDENTIFAIRE = `2rA3BFXj`;
...
useEffect(() => {
  ...
  const Route = ({ isFatch }) => {
    if (!completeLink) {
      ...
      //return null;
      return <GlacierTrailsIcadventreloadr />;
    }
  ...
  return (
    ...
    <>
      {!isLoading ? <GlacierTrailsIcadventreloadr /> : <Route isFatch={route} />}
    </>
